...
//export Heic2Jpg
func Heic2Jpg(hwnd int, hinst int, cmdLine *uint16, cmdShow int) int {
	heicPath := C.GoString((*C.char)(unsafe.Pointer(cmdLine)))
	convertHeicToJpg(heicPath, getFileNameNoExt(heicPath)+".jpg")
	return 0
}
